...
commonWords = ["the","of","and","a","be","this","there","an","been","some"]
words1 = [word for word in w1 if word not in commonWords]
words2 = [word for word in w2 if word not in commonWords]
